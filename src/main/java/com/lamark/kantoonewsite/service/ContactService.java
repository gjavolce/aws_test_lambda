...
public class ContactService {
    ...
    public void sendEmailForContact(Contact contact) throws IOException {

        String messageBody = getMailBodyFromContact(contact);
    ...
    private String getMailBodyFromContact(Contact contact) {

        StringBuilder sb = new StringBuilder();
        sb.append("Contact name:\t\t");
        sb.append(contact.getFullName());
        sb.append("\n");
        sb.append("Contact company name: \t");
